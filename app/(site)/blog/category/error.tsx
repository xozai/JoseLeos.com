  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
      <div className="w-12 h-12 rounded-full bg-[--background-secondary] flex items-center justify-center mx-auto mb-4">
        <Tag size={20} className="text-[--foreground-muted]" />
      </div>
      <h1 className="text-xl font-bold text-[--foreground] mb-2">Failed to load category</h1>
      <p className="text-[--foreground-muted] text-sm mb-6">
        There was a problem fetching posts for this category.
      </p>
