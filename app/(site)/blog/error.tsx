...
export default function BlogError({
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
      ...
      <h1 className="text-xl font-bold text-[--foreground] mb-2">Failed to load blog content</h1>
      <p className="text-[--foreground-muted] text-sm mb-6">
        There was a problem fetching posts. This usually means the CMS is unreachable.
      </p>
